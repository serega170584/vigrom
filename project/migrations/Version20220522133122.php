...
final class Version20220522133122 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE currency (id VARCHAR(3) NOT NULL, rate NUMERIC(5, 2) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE wallet (id INT NOT NULL, currency_id VARCHAR(3) NOT NULL, name VARCHAR(255) NOT NULL, balance INT NOT NULL DEFAULT 0, is_occupied BOOLEAN NOT NULL DEFAULT FALSE, PRIMARY KEY(id))');
